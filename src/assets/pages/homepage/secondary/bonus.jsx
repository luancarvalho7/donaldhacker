    ...
    return (
        <section id="bonusPage">
            ...
            <div className="bonusContent borderSpacing">
                <img src="https://imagedelivery.net/BgH9d8bzsn4n0yijn4h7IQ/c06673dc-e272-482b-50ff-a6cf2648d200/w=1280" className="bonusHouse" alt="" />
                <div className="bh-txt">
                    <h3 className='housetitle txt-gradient'>DonaldBet</h3>
